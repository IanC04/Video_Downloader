...
class Downloader(tk.Tk):
    ...
    def __init__(self):
        ...
        ws = self.winfo_screenwidth() // 4  # width of the screen
        hs = self.winfo_screenheight() // 4  # height of the screen
        ...
        self._label = tk.Label(self._frame, textvariable=self._label_text, justify=tk.CENTER,
                               font=('Courier', 14), fg='black', height=2, width=75,
        ...
        # Update button
        update = tk.Button(self._frame, text='Update', state='disabled')
        update.grid(row=5, column=0, sticky=tk.W)
